...
# Plot the result
sizeGrWindow(7, 6)
pdf(file = "5a-Clustering of module eigengenes.pdf", width = 12, height = 9)  
...
pdf(file = "5b-Clustering of module eigengenes_cutoff.pdf", width = 12, height = 9)  
...
pdf(file="newMEs.pdf",heigh=12,width=16)
...
bac_traits = read.csv("b_order_234.csv", header = T)
...
sizeGrWindow(6,6);
par(cex = 1.0)
pdf("6a_Verru_eigengene_dendrogram.pdf")
plotEigengeneNetworks(MET, "Eigengene dendrogram", marDendro = c(0,4,2,0),
                      plotHeatmaps = FALSE)
dev.off()
# Plot the heatmap matrix (note: this plot will overwrite the dendrogram plot)
par(cex = 1.0)
pdf("6b_Verru_eigengene_adjacency.pdf")
...
library(ggplot2)
pdf("8_Module-taxon_correlation_plot.pdf")
